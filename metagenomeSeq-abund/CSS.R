...
getwd()
tmp = loadMeta("Matriz_final_rhizosphere_asv.txt", sep = "\t")
taxa = read.delim("taxonomy_final_rhizosphere.txt", header=TRUE, row.names = 1, stringsAsFactors = FALSE) 
mapfile = loadPhenoData("metadata_rhizosphere.tsv", tran = TRUE)  
...
exportMat(mat, file = file.path("C:/Users/Lenovo/Documents/Scripts Spermosphere/CSS_normalized_spermosphere2.txt")) #Colocar la ruta y el nombre del archivo#
